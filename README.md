# Личный проект «SP.shop»

Сайт спортивной одежды

1. В проекте реализована верстка страницы `index.html`.
2. Адаптивность сетки: мобильная, планшетная, десктопная и десктопная HD версии .
...
8. Написан скрипт для правой части страницы:<br>
   чтобы удалялись товары;<br>
   чтобы можно было менять количество;<br>
